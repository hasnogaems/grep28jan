...
rm leaks_samples_s21.log


run_test() {
    (( NUMBER++ ))
    param=$(echo "$@" | sed "s/FLAGS/$var/")
     echo vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvTEST#$NUMBER >> leaks_samples_s21.log
     echo КОМАНДА $param >> leaks_samples_s21.log
     echo ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^#$NUMBER=FAIL^^^^^ >> leaks_samples_s21.log
